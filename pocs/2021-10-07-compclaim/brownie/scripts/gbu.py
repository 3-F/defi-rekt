...
def main():
    ...
    user1 = accounts[1]
    uni_router.swapExactETHForTokens(0, [weth, tusd], user1, chain.time() + 120, {'from': user1, 'value': 10e18})
    tusd.approve(cTUSD, (1<<256)-1, {'from': user1})
    cTUSD.mint(tusd.balanceOf(user1), {'from': user1})
